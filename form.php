...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($error_msg) && empty($phone_err)) {
        ...
        $query = "INSERT INTO  landing_form (Name, PhoneNumber, Email, Message) 
        ...
        if (mysqli_query($con, $query)) {
            ...
            try {
                ...
                $mail->setFrom('balaabimanyugnc@gmail.com', 'Brigade Insignia');
                $mail->addAddress('balaabimanyugnc@gmail.com', 'Brigade Insignia');
                $mail->isHTML(true);
                $mail->Subject = 'New Brigade Insignia Inquiry';
                $mail->Body = $html;
                ...
                $userMail->setFrom('balaabimanyugnc@gmail.com', 'Brigade Insignia');
                $userMail->addAddress($Email, $Name);
                $userMail->isHTML(true);
                $userMail->Subject = 'Thank You for Contacting Us';
                $userMail->Body = "
                    Hi <b>$Name</b>,<br><br>
                    Thank you for reaching out to <b>Brigade Insignia</b>.<br>
                    We have received your inquiry and will get back to you shortly.<br><br>
                    Regards,<br>
                    Brigade Insignia Team";
                ...
                $subject = 'New Brigade Insignia Inquiry';
